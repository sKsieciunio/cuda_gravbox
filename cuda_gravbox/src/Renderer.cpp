...
void Renderer::cleanup() {
    ...
    if (m_vbo_pos_x) glDeleteBuffers(1, &m_vbo_pos_x);
    if (m_vbo_pos_y) glDeleteBuffers(1, &m_vbo_pos_y);
    if (m_vbo_vel_x) glDeleteBuffers(1, &m_vbo_vel_x);
    if (m_vbo_vel_y) glDeleteBuffers(1, &m_vbo_vel_y);
    if (m_vbo_radius) glDeleteBuffers(1, &m_vbo_radius);
